...
import os
from flowproc.parsing import extract_group_animal, extract_tissue
...
def test_visualize_data_bar(tmp_csv, tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("flowproc.parsing.load_and_parse_df", mock_load_and_parse_df)
    monkeypatch.setattr("flowproc.transform.map_replicates", mock_map_replicates)
