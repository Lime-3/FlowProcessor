...
import logging
from flowproc.parsing import parse_time, extract_group_animal, extract_tissue, get_tissue_full_name, load_and_parse_df, is_likely_id_column, ParsedID, Constants
...
# In test_parsing.py, add to parametrized test_extract_group_animal
@pytest.mark.parametrize("sample_id, expected", [
    # ... existing cases
    ("1.1.fcs", ParsedID(well=Constants.UNKNOWN_WELL.value, group=1, animal=1, time=None)),
])

# Add to test_load_and_parse_df_messy for another real CSV
@pytest.fixture
